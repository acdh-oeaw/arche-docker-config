...
if [ ! -d /home/www-data/gui/web ]; then
    ...
    su -l www-data -c "cd /home/www-data/gui && composer require drush/drush acdh-oeaw/arche_core_gui acdh-oeaw/arche_core_gui_api acdh-oeaw/arche_core_gui_static acdh-oeaw/arche-theme-bs composer/installers drupal/core-composer-scaffold drupal/core-project-message drupal/core-recommended drupal/devel drupal/devel_entity_updates drupal/entity_clone:2.1.0-beta1 drupal/restui drupal/matomo --update-no-dev && composer dump-autoload -o"
else
