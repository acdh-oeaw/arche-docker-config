...
if [ ! -d /home/www-data/docroot/browser ]; then
    ...
    su -l www-data -c "cd /home/www-data/docroot/browser && composer require drush/drush drupal/bootstrap_mint acdh-oeaw/arche-gui acdh-oeaw/arche-theme --update-no-dev"
